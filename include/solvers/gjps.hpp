...
namespace chdr::solvers {
    ...
    private:
        ...
        struct node final : managed_node<index_t, node> {
            ...
            [[nodiscard]] constexpr node(index_t _index, const direction_t& _direction, scalar_t _gScore, scalar_t _hScore, node* RESTRICT const _parent = nullptr) noexcept : managed_node<index_t, node>(_index, _parent),
                m_gScore(_gScore),
        ...
        [[nodiscard]] HOT static constexpr auto solve_internal(open_set_t& _open, closed_set_t& _closed, size_t _capacity, const params_t& _params) {
            ...
            __CHDR_UTILS_STATIC_WARNING_NIF(params_t::octile_neighbours::value, "This implementations of GJPS only supports octile grids.");
