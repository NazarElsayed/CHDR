...
#ifndef CHDR_OSMASTAR_HPP
#define CHDR_OSMASTAR_HPP
...
namespace chdr::solvers {
     ...
     * - May take longer to find solutions than SMA*.
    ...
    struct [[maybe_unused]] osmastar final {

        friend class solver<osmastar, params_t>;
    ...
    private:
        ...
        using solver_t = solver<osmastar, params_t>;
