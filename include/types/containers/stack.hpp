...
namespace chdr {
    ...
    public:
         ...
         */
        [[maybe_unused, nodiscard]] explicit constexpr stack(std::pmr::memory_resource* _resource = std::pmr::get_default_resource()) : c(_resource) {}
         ...
         *                       If not provided, the default memory resource is utilised.
         */
        [[maybe_unused, nodiscard]] explicit constexpr stack(size_t _capacity, std::pmr::memory_resource* _resource = std::pmr::get_default_resource()) : c(_resource) {
            c.reserve(_capacity);
        }
